...
import org.jmotor.util.exception.DownloadException;
...
public class DownloadUtilities {
    ...
    public static File download(File directory, String downloadPath) {
        ...
        try {
            ...
            StreamUtilities.copyLarge(inputStream, outputStream);
            ...
            CloseableUtilities.closeQuietly(outputStream);
        }
        return file;
    }
    ...
    public static File download(File directory, String fileName, String downloadPath, String checksum) {
        ...
        try {
            ...
            String _checksum = MD5Utilities.getHex(digest.digest());
            if (ObjectUtilities.isDifferent(checksum, _checksum)) {
